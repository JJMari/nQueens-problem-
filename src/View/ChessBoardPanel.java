...
/**
 *Classe que representa es tauler s'escacs
 * @author marij
 */
public class ChessBoardPanel extends JPanel {
    ...
    /**
     * Coloca una peça a la fila i columna especificada. Després repinta el
     * tauler.
     *
     * @param col
     * @param fila
     * @param drawable
     */
    public void printPiece(int col, int fila, CellDrawable drawable) {
